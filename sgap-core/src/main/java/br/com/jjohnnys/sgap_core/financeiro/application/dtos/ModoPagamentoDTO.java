...
public record ModoPagamentoDTO(Long id, Long idPaciente, String plano, BigDecimal valor, Integer diaDoMes) {
    ...
    public ModoPagamento criarModoPagamento() {
         return new ModoPagamento(id, idPaciente, PlanoEnum.getPlanoEnum(plano) , valor, diaDoMes);
    }

    public static ModoPagamentoDTO criarModoPagamentoDTO(ModoPagamento modoPagamento) {
        return new ModoPagamentoDTO(modoPagamento.getId(), modoPagamento.getIdPaciente(), modoPagamento.getPlano().name(), modoPagamento.getValorPorConsulta(), modoPagamento.getDiaDoMes());
    }
